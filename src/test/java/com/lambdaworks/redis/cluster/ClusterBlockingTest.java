 ...
 * @author Mark Paluch
 */
public class ClusterBlockingTest {
    ...
    public void name() throws Exception {
        ...
        connect.reactive().set("key", "value").flatMap(s -> connect.reactive().set("foo", "bar"))
                .flatMap(s -> connect.reactive().keys("*")).doOnError(Throwable::printStackTrace).toBlocking().last();
    }
}
