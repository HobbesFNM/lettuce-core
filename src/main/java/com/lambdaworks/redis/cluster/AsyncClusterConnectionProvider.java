...
interface AsyncClusterConnectionProvider extends Closeable {
     ...
     *        {@literal READ} connections will be provided in {@literal READONLY} mode
     ...
     *
     * @param intent {@link Intent#READ} or {@link Intent#WRITE} {@literal READ} connections will be provided in
     *        {@literal READONLY} mode
